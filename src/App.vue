<template>
  <div id="app" class="contain">
    <GameStateStart v-if="uiState === 'start'">
      <h2>Which human you want to be?</h2>
      <p
    ...
    <section v-else-if="uiState === 'characterChosen'">
      <svg viewBox="0 -180 1628 1180" class="main">
        ...
        <componet :is="character"></componet>
        <text
          x="1000"
          y="930"
      ...
      <div class="zombietalk">
        <p v-for="character in shuffleData(characterChoices)" :key="character">
...
export default {
  ...
  methods: {
    pickCharacter() {
      console.log("abc..", this.characterInput);
